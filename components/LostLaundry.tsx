...
export const LOST_ITEMS: LostItem[] = [
  {
    ...
    story: '레코딩 당일 이루마님이 스튜디오에 들어서던 순간, 피아노 선율이 귓가에 포근하게 울려 퍼졌습니다.'
  },
  {
    id: 1, position: [0.9, 0.06, -12.9], albumId: 36, color: '#B8D4E8', albumTitle: '잠들 때까지',
    story: '데뷔 앨범 발매 전날 밤, 저희는 홍대의 작은 카페에 모여 처음으로 전곡을 들었습니다. 그리고는 꿈이 이루어 졌다며 기뻐했던 기억이 납니다.'
  },
  {
    id: 2, position: [-0.7, 0.06, -14.3], albumId: 6, color: '#B8D4E8', albumTitle: '오렌지빛을 쥐고',
    story: '커피를 사러 나갔다가 충동적으로 치과에 들어가 스케일링을 받았습니다.'
  },
  {
  ...
  },
  {
    ...
    story: '"파랑" 데모는 핸드폰 메모장에서 시작됐습니다. 새벽 3시, 불 꺼진 거실에서 핸드폰 빛에 의지해 악보를 그리던 최시유가 있었습니다.'
  },
]
